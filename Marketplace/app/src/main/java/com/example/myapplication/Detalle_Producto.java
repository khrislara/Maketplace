...
public class Detalle_Producto extends AppCompatActivity {
    ...
    private void cargarDatosSimulados(String id) {
        ...
        tvDescripcionDetalle.setText("Modelo 2024, casi nueva. Perfecta para la ciudad y subir
                cuestas sin esfuerzo. Incluye cargador y garantía.");
    ...
    private void realizarLlamada() {
        ...
        try {
            ...
            // Verificación: Comprueba si el dispositivo tiene una aplicación capaz de manejar el
            Intent.
            if (intentLlamada.resolveActivity(getPackageManager()) != null) {
                startActivity(intentLlamada);
            } else {
                Toast.makeText(this, "No se encontró una aplicación para realizar llamadas en el
