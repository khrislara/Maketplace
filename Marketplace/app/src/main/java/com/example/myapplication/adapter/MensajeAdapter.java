...
public class MensajeAdapter extends
    ...
    private static final int VIEW_TYPE_EMISOR = 1; // Mensaje enviado por el usuario actual
(derecha)
    private static final int VIEW_TYPE_RECEPTOR = 2; // Mensaje recibido por el usuario actual
(izquierda)
